...
/* template */
var __vue_render__ = function (_h,_vm) {var _c=_vm._c;return _c('ul',{staticClass:"vsc-popup-body__list"},[_vm._ssrNode((_vm._ssrList((_vm.props.attendants),function(attendant,index){return ("<li class=\"vsc-popup-body__list-item\"><a"+(_vm._ssrAttr("href",attendant.href))+" rel=\"noopener\" target=\"_blank\""+(_vm._ssrAttr("aria-label",("Contact " + (attendant.name) + ", opens in a new window")))+" class=\"vsc-popup-body__link\"><div class=\"vsc-popup-body__link-avatar\"><img"+(_vm._ssrAttr("src",attendant.avatar.src))+(_vm._ssrAttr("alt",attendant.avatar.alt))+"> <span class=\"vsc-popup-body__link-avatar-brand\""+(_vm._ssrStyle(null,attendant.app ? ("background-image: url(" + (_vm.props.urlAsset) + "/logos/" + (attendant.app) + ".png)") : '', null))+"></span></div> <div class=\"vsc-popup-body__link-info\"><span class=\"vsc-popup-body__link-info__label\">"+_vm._ssrEscape(_vm._s(attendant.label))+"</span> <span class=\"vsc-popup-body__link-info__name\">"+_vm._ssrEscape(_vm._s(attendant.name))+"</span></div></a></li>")})))])};
var __vue_staticRenderFns__ = [];
  ...
  /* module identifier */
  var __vue_module_identifier__ = "data-v-d704e1de";
  /* functional template */
